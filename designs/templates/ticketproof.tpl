...
<body>
	<form method="post" action="" >
		<table align="center">
			...
			<tr><td>Full Name</td><td><input type="text" name="name" class="form-control" value="{$dc.name}" readonly></td></tr>
			...
			<tr><td>Depot</td><td><input type="text" name="depot" class="form-control" value="{$dc.depot}" readonly></td></tr>
				<tr><td>Amount</td><td><input type="text" name="amount" class="form-control" value="{$dc.amounts}" readonly></td></tr>
