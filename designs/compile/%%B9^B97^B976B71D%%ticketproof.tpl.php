<?php /* Smarty version 2.6.26, created on 2022-04-24 12:10:10
         compiled from ticketproof.tpl */ ?>
<html>
...
?>
			<tr><td>Full Name</td><td><input type="text" name="name" class="form-control" value="<?php echo $this->_tpl_vars['dc']['name']; ?>
" readonly></td></tr>
...
" readonly></td></tr>
				<tr><td>Amount</td><td><input type="text" name="amount" class="form-control" value="<?php echo $this->_tpl_vars['dc']['amounts']; ?>
" readonly></td></tr>
