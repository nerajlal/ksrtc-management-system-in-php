<?php /* Smarty version 2.6.26, created on 2022-05-12 18:48:02
         compiled from studhome.tpl */ ?>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
               ...
               <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                  <ul class="navbar-nav ">
                     ...
                     <li class="nav-item">
                        <a href="stdproup.php" class="nav-link">Profile</a>
                     </li>
                     <!-- <li class="nav-item">
                        <a href="complaint.php" class="nav-link">Complaint</a>
                     </li>
                      --><!-- <li class="nav-item">
                        <a href="ticket.php" class="nav-link">Concession Ticket</a>
                     </li> -->
                     <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                           <a class="nav-link" href="compstud.php">Admin</a>
                           <a class="nav-link " href="complaint.php">Ato</a>
                        <a class="nav-link " href="comview.php">View Admin</a>
<a class="nav-link " href="complaintview.php">View Ato</a>
                     ...
                     <li class="nav-item dropdown">
                        ...
                        Confirmation<?php if ($this->_tpl_vars['views'] != null): ?>
                        (1)
                        <?php else: ?>
                        (0)<?php endif; ?>
                        </a>
                        ...
                        <a class="nav-link " href="reqstdview.php">Confirmation Letter</a>
                    ...
                    <!--  <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                         Complaint Reply<?php if ($this->_tpl_vars['views'] != null): ?>
                        (1)
                        <?php else: ?>
                        (0)<?php endif; ?>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                           <a class="nav-link" href="adminreply.php">Admin</a>
                           <a class="nav-link " href="atoreply.php">ATO</a>
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                           <a class="nav-link" href="ticket.php">Apply Concession</a>
                           <a class="nav-link " href="ticketview.php">My Application</a>
                      <!--  <a class="nav-link " href="ticketdownload.php">Download</a>
                       --> 
                        </div>
                     </li>
                     <li class="nav-item">
                                    <a class="nav-link" href="help4.php">Help</a>
                                </li>
               ...
               <ul class="rslides" id="slider4">
                  ...
                  <li>
                     <div class="slider-img two-img">
                        <div class="container">
                           <div class="slider-info ">
                              <h5><br>CONCESSION FOR STUDENTS</h5>
                             <!--  <div class="bottom-info">
                                 <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.Aenean commodo ligula eget dolorL orem ipsum dolor sit amet eget dolor</p>
                              </div>
                              <div class="outs_more-buttn">
