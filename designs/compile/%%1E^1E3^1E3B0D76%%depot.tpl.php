<?php /* Smarty version 2.6.26, created on 2022-01-15 10:21:31
         compiled from depot.tpl */ ?>
<html>
...
<body>
	<form method="post" action="" >
		<table align="center">
			...
			<tr><td>Depot Name</td><td><input type="text" name="name" class="form-control"></td></tr>
