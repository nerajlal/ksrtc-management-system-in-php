<?php /* Smarty version 2.6.26, created on 2022-05-08 11:28:33
         compiled from adminstudview.tpl */ ?>
<?php echo '
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">DataTable With Student Registration</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
?>
          ...
          <td><?php echo $this->_tpl_vars['a']['institution']; ?>
</td>
         <td><?php echo $this->_tpl_vars['a']['course']; ?>
</td>
          <td><?php echo $this->_tpl_vars['a']['semester']; ?>
</td>
           <td><?php echo $this->_tpl_vars['a']['contactno']; ?>
</td>
          <td><?php echo $this->_tpl_vars['a']['email']; ?>
</td>
          <td><a href="adminstudview.php?key=<?php echo $this->_tpl_vars['a']['lkey']; ?>
" </a></td>
          </tr>
