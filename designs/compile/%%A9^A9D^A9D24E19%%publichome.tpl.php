<?php /* Smarty version 2.6.26, created on 2022-05-04 08:40:41
         compiled from publichome.tpl */ ?>
               ...
               <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                  <ul class="navbar-nav ">
                     <li class="nav-item active">
                        <a class="nav-link" href="publichome.php">Home <span class="sr-only">(current)</span></a>
                     </li>
                     <li class="nav-item">
                        <a href="pubproup.php" class="nav-link">Profile</a>
                     </li>
                      <!--  -->
                    <!--  <li class="nav-item">
                        <a href="usercomplaint.php" class="nav-link">Complaint</a>
                     </li>
                     --><!--  <li class="nav-item">
                     ...
                     <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="nav-link" href="usercomplaint.php">Add Complaint</a>
                        <a class="nav-link " href="usercomview.php">My Complaint</a>
                     </div>
                  </li>
                  <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     ...
                     <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="nav-link" href="dcardpubpay.php">Apply Dcard</a>
                        <a class="nav-link " href="dcardpubview.php">My Application</a>
                     </div>
                  </li>
                   <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Job
                     ...
                     <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="nav-link" href="jpublicview.php">Apply</a>
                        <a class="nav-link " href="jobpubview.php">Confirm</a>
                     </div>
                  </li>
                  <!-- <li class="nav-item dropdown">
                     ...
                     <li class="nav-item">
                                    <a class="nav-link" href="help5.php">Help</a>
                                </li>
               ...
               <ul class="rslides" id="slider4">
                     ...
                     <div class="slider-img one-img">
                        <div class="container">
                           <div class="slider-info ">
                              <h5>KSRTC<br>CONCESSION WITH D-CARD</h5>
                  ...
                  <li>
                     <div class="slider-img two-img">
                        <div class="container">
                           <div class="slider-info ">
                              <h5><br>CONCESSION FOR STUDENT</h5>
                              <!-- <div class="bottom-info">
                                 <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.Aenean commodo ligula eget dolorL orem ipsum dolor sit amet eget dolor</p>
                              </div>
                              <div class="outs_more-buttn">
     ...
     <!--              <div class="text-center">
      ...
      <footer class="py-lg-4 py-md-3 py-sm-3 py-3 text-center">
         <div class="copy-agile-right">
            <p> 
               © 2022 KSRTC. All Rights Reserved | Design by <a  target="_blank">ANNA</a>
            </p>
         </div>
      </footer>
      <!-- //footer -->
