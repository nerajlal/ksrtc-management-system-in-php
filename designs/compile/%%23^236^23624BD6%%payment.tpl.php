<?php /* Smarty version 2.6.26, created on 2022-03-22 10:23:23
        ...
        <div class="responsive_tabs w3ls_tab">
            <div id="horizontalTab">
                <ul class="resp-tabs-list">
                    <li>Credit/Debit</li>
                    <li>Net Banking</li><!-- <li>Paypal Account</li>
                 --></ul>
                                    ...
                                    <div class="credit-card-wrapper">
                                        <div class="first-row form-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <input class="expiration-month-and-year form-control" type="text" name="expiry_date" placeholder="MM / YY">
                                            </div>
                                        </div>
                                        <button class="submit">
                                ...
                                <form action="#" method="post">
                                    ...
                                    <div class="swit-radio">
                                        <div class="check_box_one">
                                            <div class="radio_one">
                                                <label>
                                                    <input type="radio" name="radio" onclick="location.href='https://www.fednetbank.com/'">
                                        ...
                                        <div class="check_box_one">
                                            <div class="radio_one">
                                                <label>
                                                    <input type="radio" name="radio" onclick="location.href='https://www.icicibank.com/Personal-Banking/insta-banking/internet-banking/index.page'">
                                        ...
                                        <div class="check_box_one">
                                            <div class="radio_one">
                                                <label>
                                                    <input type="radio" name="radio"  onclick="location.href='https://netbanking.canarabank.in/entry/ENULogin.jsp'">
                                        ...
                                        <div class="check_box_one">
                                            <div class="radio_one">
                                                <label>
                                                    <input type="radio" name="radio"  onclick="location.href='https://www.indianbank.net.in/jsp/startIB.jsp'">
                                        ...
                                        <div class="check_box_one">
                                            <div class="radio_one">
                                                <label>
                                                    <input type="radio" name="radio"  onclick="location.href='https://www.onlinesbi.com/'">
                                            ...
                                            <div class="first-row form-group">
                                                ...
                                                <div class="paymntf_card_number_grids">
                                                    ...
                                                    <div class="fpay_card_number_grid_right">
                                                        <div class="controls">
                                                            <label class="control-label">CVV</label>
                                                            <input class="security-code form-control" Â· inputmode="numeric" type="text" name="securitycode" placeholder="&#149;&#149;&#149;">
                                                        </div>
                                                    </div>
                                                    <div class="clear"> </div>
                                                </div>
