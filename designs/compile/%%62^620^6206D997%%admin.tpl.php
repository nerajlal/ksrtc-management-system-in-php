<?php /* Smarty version 2.6.26, created on 2022-05-08 09:40:20
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3><?php echo $this->_tpl_vars['ato']; ?>
</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3><?php echo $this->_tpl_vars['student']; ?>
</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3><?php echo $this->_tpl_vars['public']; ?>
</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h3><?php echo $this->_tpl_vars['institution']; ?>
</h3>
