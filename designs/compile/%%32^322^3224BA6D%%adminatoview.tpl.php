<?php /* Smarty version 2.6.26, created on 2022-05-08 11:28:25
         compiled from adminatoview.tpl */ ?>
<?php echo '
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">DataTable With ATO Registration</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
?>
          ...
          <td><a href="atoapp.php?key=<?php echo $this->_tpl_vars['a']['lkey']; ?>
" class="btn btn-primary">Approve</a></td>
          <td><a href=" atorej.php?key=<?php echo $this->_tpl_vars['a']['lkey']; ?>
...
" class="btn btn-primary">Approve</a></td>
  ...
  <!-- <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021-2022 <a href="https://adminlte.io">KSRTC.io</a>.</strong> All rights reserved.
  </footer>
 -->
  <!-- Control Sidebar -->
