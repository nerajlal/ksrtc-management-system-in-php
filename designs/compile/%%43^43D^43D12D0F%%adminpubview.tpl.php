<?php /* Smarty version 2.6.26, created on 2022-05-08 11:28:37
         compiled from adminpubview.tpl */ ?>
  <?php echo '
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">DataTable With Public Registration</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
?>
 <tr>
          <td><?php echo $this->_tpl_vars['p']['fullname']; ?>
</td>
          <td><?php echo $this->_tpl_vars['p']['address']; ?>
</td>
          <td><?php echo $this->_tpl_vars['p']['pincode']; ?>
</td>
            <td><?php echo $this->_tpl_vars['p']['gender']; ?>
</td>
        <td><?php echo $this->_tpl_vars['p']['date_of_birth']; ?>
</td>
          <td><?php echo $this->_tpl_vars['p']['district']; ?>
</td>
          <td><?php echo $this->_tpl_vars['p']['city']; ?>
</td>
          <td><?php echo $this->_tpl_vars['p']['contactno']; ?>
</td>
          <td><?php echo $this->_tpl_vars['p']['email']; ?>
</td>
