...
$pdf->Cell(2,05,"               ",0,1);
$pdf->Cell(20,05,"              ",0,1);
$pdf->Cell(20,05,"   Keep this bill safe Its the proof ",0,1);
$pdf->Rect(10, 80, 190, 148, 'D'); 
$pdf->Line(100,80,100,228);
	$pdf->Cell(0,15,"    ",0,1,'C');
	$pdf->Cell(20,10,"Name of person to whom certificate is issued",0,0);
...
// $pdf->Line(5,60,205,60);
	...
	$pdf->Cell(20,10,"Date 0f issue of bill        ",0,0);
...
// 	$pdf->Cell(20,10,"                                                                       Village Officer",0,1);
	...
	$pdf->SetFont("Arial","",9);
	$pdf->Cell(20,05,"This bill is issued based on the details given ",0,1);
...
// 	$pdf->Cell(20,05,"2. Authenticity of this document can be verified from http://edistrict.kerala.gov.in/ and submitting the Certificate Number.                                                                                        ",0,1);
  ...
  // $pdf->Image("{$f2}",65,90,30);
	...
	$pdf->output();
		...
		$smartyObj->display('ticketproof.tpl');
